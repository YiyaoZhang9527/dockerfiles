...
# Sensor Factory 类继承 GstRtspServer 基类并添加
# properties to it.
class SensorFactory(GstRtspServer.RTSPMediaFactory):
    def __init__(self, **properties):
        ...
        self.fps = opt.fps
        self.duration = 1 / self.fps * Gst.SECOND  # duration of a frame in nanoseconds # 一帧的持续时间，以纳秒为单位
...
# Rtsp 服务器实现，我们将工厂传感器与流 uri 连接起来
